      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              },
              {
                  name: 'ngPrint',
                  files: [
                      'views/vendor/modules/ng-print/html2canvas.min.js',
                      'views/vendor/modules/ng-print/jspdf.min.js',
                      //'views/vendor/modules/ng-print/ngPrint.min.js',
                      'views/vendor/modules/ng-print/ngPrint.debug.js',
                      'views/vendor/modules/ng-print/pixastic-standalone.js',
                      'views/vendor/modules/ng-print/pixastic-crop.js',
                  ]
              },
              {
                  name: 'pdfMaker',
                  files: [
                          'views/vendor/modules/pdfmake/pdfmake.js',
                          'views/vendor/modules/pdfmake/vfs_fonts.js',
                  ]
              },
